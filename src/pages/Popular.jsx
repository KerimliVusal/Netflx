...
function Popular() {
  ...
  useEffect(()=>{
    axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=19d5dcc0918f5300be53acc029f125ef&language=en-US&page=${Currentpage}`)
  ...
  return (
    ...
    >
      ...
      <h1 className='text-center py-4 fw-bold'>Popular Movies</h1>
