...
function Trending() {
  ...
  useEffect(()=>{
    axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=19d5dcc0918f5300be53acc029f125ef&language=en-US&page=${Currentpage}`)
    ...
    >
       ...
       <SwiperSlide className='h-100' key={index} >
        ...
        <div className="container">
          <h1 className='text-center fw-bold py-4'>Top Rated Movies</h1>
